...
const LandingPage = () => {
  ...
  return (
    <div className="min-h-screen bg-[#111b21] text-white flex flex-col">
      {/* Hero Section */}
      <section className="flex flex-col md:flex-row items-center justify-between px-8 py-16 md:py-24 bg-gradient-to-br from-[#111b21] via-[#202c33] to-[#005c4b] relative overflow-hidden">
      ...
      {/* Features Section */}
      <section className="py-16 px-4 md:px-16 bg-[#111b21]">
      ...
      {/* About/CTA Section */}
      <section className="py-16 px-4 md:px-16 bg-gradient-to-t from-[#202c33] to-[#111b21] flex flex-col md:flex-row items-center justify-between animate-fadeIn">
      ...
      {/* Contact Us Section */}
      <section className="py-16 px-4 md:px-16 bg-[#202c33]">
